...
import (
	...
	upgrade "github.com/openshift-psap/special-resource-operator/pkg/upgrade"
...
func (m *MockClusterInfo) GetClusterInfo(arg0 context.Context, arg1 *v1.NodeList) (map[string]upgrade.NodeVersion, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetClusterInfo", arg0, arg1)
	ret0, _ := ret[0].(map[string]upgrade.NodeVersion)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
