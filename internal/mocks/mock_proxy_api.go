...
import (
	...
	proxy "github.com/openshift-psap/special-resource-operator/pkg/proxy"
...
func (m *MockProxyAPI) ClusterConfiguration(ctx context.Context) (proxy.Configuration, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ClusterConfiguration", ctx)
	ret0, _ := ret[0].(proxy.Configuration)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
